...
namespace redb.ConsoleTest
{
    ...
    public class SimpleTreeTest
    {
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                var logger = provider.GetRequiredService<ILogger<SimpleTreeTest>>();
                
                logger.LogInformation("🔧 Создаем схему для тестов...");
                
                // Создаем схему
                var scheme = await redb.SyncSchemeAsync<SimpleTestProps>();
    ...
    /// </summary>
    [RedbScheme("Простые тестовые свойства")]
